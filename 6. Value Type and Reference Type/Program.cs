...
namespace OOP_Vj7
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // 4. Kreirati novu instancu razreda Naselje i usporediti s već ranije kreiranom instancom istog razreda
            Naselje n4 = new Naselje("Dragoslavec", 351, VrstaNaselja.Selo);
            Console.Write("Naselje " + n4.GetNaziv() + " i naselje " + n3.GetNaziv());
            if (n4.Jednako(n3))
            {
                Console.Write(" su jednaki.");
            }
            else
            {
                Console.Write(" su različiti.");
            }
